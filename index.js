...
// Tenta ler a chave da API da variável de ambiente GEMINI_API_KEY
const GEMINI_API_KEY = process.env.GEMINI_API_KEY;

// Verifica se a chave da API foi realmente definida.
// Se não, exibe um erro e sai para evitar problemas.
if (!GEMINI_API_KEY) {
...
const MAX_RETRIES = 5;
const RETRY_DELAY_MS = 5000; // 5 segundos de espera
